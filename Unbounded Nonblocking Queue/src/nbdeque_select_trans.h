// Maxim Shelopugin
// GIS deque reimplementation using selective transactions
...
// // Atomic stradling/boundary push
			else{
				__transaction_atomic{
...
// Atomic boundary/straddling push
			else{
				__transaction_atomic{
...
// Atomic boundary/straddling pop
...
// Atomic straddling/boundary pop
// pop progression as necessary: seal left node,
// remove left node, then boundary pop
			else{
				__transaction_atomic{
